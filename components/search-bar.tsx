...
export function SearchBar() {
  ...
  return (
    <form onSubmit={handleSearch} className="bg-white dark:bg-slate-900 rounded-lg shadow-xl p-6 max-w-3xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <Select value={transaction} onValueChange={setTransaction}>
          ...
          <SelectContent>
            <SelectItem value="">À louer & À vendre</SelectItem>
      ...
      <div className="space-y-3">
        <label className="text-sm font-medium">Budget: {new Intl.NumberFormat('fr-FR').format(priceRange[0])} - {new Intl.NumberFormat('fr-FR').format(priceRange[1])} FCFA</label>
        <Slider
          min={0}
          max={500000000}
          step={5000000}
